...
import { RealtimeMicTest } from "./realtime-mic-test";
import type { AudioCaptureSession } from "../../domain/audio-capture";

export default function MicTestHarness() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1>Local microphone test</h1>
        <p style={{ color: "#aeb8d0" }}>
          Local test only: audio stays in memory and is not uploaded or stored.
          The separate Realtime test below sends microphone audio to OpenAI.
        </p>
